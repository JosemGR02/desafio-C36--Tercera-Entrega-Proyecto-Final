...
const config = {
    ...
    WHATSAPP: {
        NRO_TWILIO: process.env.MSJ_WHATSAPP_NRO_SERVICIO,
        NRO_ADMIN: process.env.MSJ_WHATSAPP_NRO_ADMIN,
        ID_CUENTA: process.env.MSJ_WHATSAPP_ID_CUENTA,
        TOKEN_AUTHN: process.env.MSJ_WHATSAPP_TOKEN_AUTENTICACION,
    }
